...
const columns = [
  ...
  {header: "Xp de minage", field: "xpBeforeNextMiningLevel", isSortable: false},
  {header: "Xp total de minage", field: "totalMiningXp", isSortable: true},
  {header: "Niveau de combat", field: "combatLevel", isSortable: true},
  {header: "Xp de combat", field: "xpBeforeNextCombatLevel", isSortable: false},
  {header: "Xp total de combat", field: "totalCombatXp", isSortable: true},
